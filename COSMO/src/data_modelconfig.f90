...
! ----------------------------------------------------
 ...
 ! "IF ASSOCIATED"  between pure COSMO and COSMO/MESSY setup
  LOGICAL :: lalloc_h_ice   = .FALSE.
  LOGICAL :: lalloc_w_g3    = .FALSE.
  LOGICAL :: lalloc_t_cl    = .FALSE.
  LOGICAL :: lalloc_t_s_bd  = .FALSE.
  LOGICAL :: lalloc_w_g3_bd = .FALSE.
  LOGICAL :: lalloc_prr_gsp = .FALSE.
  LOGICAL :: lalloc_prr_con = .FALSE.
  LOGICAL :: lalloc_prs_gsp = .FALSE.
  LOGICAL :: lalloc_prs_con = .FALSE.
  LOGICAL :: lalloc_prg_gsp = .FALSE.
  LOGICAL :: lalloc_tke     = .FALSE.
