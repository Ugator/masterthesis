...
USE data_runcontrol, ONLY:   &
    ...
    itype_sher,                                                              &
    ltmpcor, lexpcor, lnonloc, lcpfluc, limpltkediff,                        &
    ! but only for __COSMO__
    ntstep, lperi_x, lperi_y, l2dim
...
!------------------------------------------------------------------------------
  ...
  REAL (KIND=ireals),       INTENT (IN), TARGET           :: &
!
...
!------------------------------------------------------------------------------
  ...
  REAL (KIND=ireals),       INTENT(IN), TARGET, OPTIONAL :: &
...
!------------------------------------------------------------------------------
  ...
  REAL (KIND=ireals),       INTENT(INOUT), TARGET, OPTIONAL :: &
...
!US  REAL (KIND=ireals),       INTENT(OUT), OPTIONAL   :: &
!US
...
!                 Hilfe von c_tke*Ustar bestimmt: 
                  ...
                  tke(i,j,ke1,ntur)=c_tke*vel*SQRT(tcm(i,j))
               END DO   
               END DO   
