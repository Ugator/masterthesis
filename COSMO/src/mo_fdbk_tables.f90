...
!
! $Id: mo_fdbk_tables.f90,v 4.28 2013-07-12 11:21:32 for0adm Exp $
!-------------------------------------------------------------------------------
!
...
public :: OC_SRSCD, OC_ATSCD, OC_AHSCD, OC_ATSHS, OC_AIRCD, OC_CODAR, &
          ...
          OC_PR_US, OC_WP_JP, OC_RAVAD, OC_SEVIR, OC_ASCAT, OC_QSCAT, &
          OC_TMPMB, OC_PLTMB, OC_AIRS,  OC_IASI,  OC_CLPRD
...
public :: VN_U, VN_V, VN_Z, VN_DZ, VN_RH, VN_RH2M, VN_T, VN_TD, VN_T2M,   &
          ...
          VN_ICLG, VN_PWC, VN_NUM, VN_RADVEL, VN_FLEV, VN_REFL,           &
          VN_RADIANCE, VN_RREFL, VN_CTH, VN_TRH, VN_VGUST, n_vn
...
public :: VE_ENS_MEAN, VE_DETERM, VE_ENS_SPREAD, VE_BG_ERROR, VE_TALAGRAND,  &
          VE_VQC_WEIGHT, VE_MEMBER, VE_ENS_MEAN_OBS
...
integer ,parameter :: OT_SYNOP =  1 ,&
                      ...
                      OT_GPSGB = 12 ,&
                      OT_RADAR = 13
integer ,parameter :: n_ot     = 13   ! number of observation types

!--------------
! table entries
!--------------
type (e) ,target :: obstype_entries (13) = (/                             &
...
! table entries
!--------------
type (e) ,target :: codetype_entries (32) = (/                        &
...
integer, parameter :: n_vn       =  66   ! number of variable numbers
...
type (e) ,target :: ensmem_entries (8) = (/                               &
