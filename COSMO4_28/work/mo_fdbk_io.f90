...
!
! $Id: mo_fdbk_io.f90,v 4.28 2013-07-12 11:21:32 for0adm Exp $
!
MODULE mo_fdbk_io
!
! Description:
  ...
  !------------------------------------------------------------
    ...
    if (nv == data% f% n_veri .and. nb == data% f% n_body) then
      ...
      if (present(fill)) then
        fillvalue = get_fillvalue (data% f, 'veri_data')
...
!==============================================================================
  ...
  integer            ,intent(in)    :: p_pe
    ...
    !--------------------------------------------
    IF ( nv > 0 ) &
       call   bcast_fdbk_meta   (data% veri_meta (1:nv),  src  )
