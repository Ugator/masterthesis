...
! ------------
  ...
  CHARACTER (LEN= 10) :: yvarini(nzmxin) ! list of initial fields 
  ...
  INTEGER   (KIND=iintegers) ,PARAMETER  ::     &
    nanfld=14       ! max. number of input fields to be checked for
...
! -------------
  ...
  CHARACTER (LEN= 10) :: yvarbd (nzmxin) ! list of boundary fields 
...
TYPE pp_nl
  ...
  CHARACTER (LEN=10)         :: yvarml(nzmxml)     ! list of m-variables
  CHARACTER (LEN=10)         :: yvarpl(nzmxpl)     ! variables of p-levels
  CHARACTER (LEN=10)         :: yvarzl(nzmxzl)     ! variables of z-levels
  CHARACTER (LEN=10)         :: yvarsl(nzmxzl)     ! variables of satellite-levels
  CHARACTER (LEN=10)         :: yvarc (nzmxc )     ! constant variables
