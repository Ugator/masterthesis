...
#ifdef MESSY
! In case of COSMO/MESSy use MESSy KIND definitions
...
#else
  INTEGER, PARAMETER       ::  ireals      = dp
  INTEGER, PARAMETER       ::  iintegers   = i4
#endif
...
! ------------------------------------------------------------------------
  ...
  INTEGER, PARAMETER       ::                                         &
       ...
       isingle   = KIND (1.0)
#else
  INTEGER, PARAMETER       ::  idouble = dp
  INTEGER, PARAMETER       ::  isingle = sp
#endif
