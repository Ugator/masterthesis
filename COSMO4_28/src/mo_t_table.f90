...
!
! $Id: mo_t_table.f90,v 4.28 2013-07-12 11:21:32 for0adm Exp $
!-------------------------------------------------------------------------------
!
MODULE mo_t_table
!
...
!==============================================================================
  ...
  !-------------------------------------------------------------
    ...
    if (tex) then
      ...
      write (1,'(a)') BS//'begin{table}[ht]'
      write (1,'(a)') BS//'begin{center}'
      write (1,'(a)') BS//'begin{tabular}{rlcl}'
