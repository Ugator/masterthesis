...
INTEGER (KIND=iintegers), PARAMETER  :: &
  ilen_sn       = 10_iintegers,     & ! length of name (character)
...
INTEGER (KIND=iintegers), SAVE :: idt_qv = -99
INTEGER (KIND=iintegers), SAVE :: idt_qc = -99
INTEGER (KIND=iintegers), SAVE :: idt_qi = -99
INTEGER (KIND=iintegers), SAVE :: idt_qr = -99
INTEGER (KIND=iintegers), SAVE :: idt_qs = -99
INTEGER (KIND=iintegers), SAVE :: idt_qg = -99
#endif
